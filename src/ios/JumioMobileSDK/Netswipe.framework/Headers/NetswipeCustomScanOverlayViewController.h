//
//  NetswipeCustomScanOverlayViewController.h
//  JumioMobileSDK
//
//  Created by Jumio Inc. on 26/01/15.
...
@class NetswipeCustomScanOverlayViewController;
...
@interface NetswipeCustomScanOverlayViewController : UIViewController

/**
 * The delegate that handles the callbacks sent from the ScanViewController
 **/
@property (nonatomic, weak) id<NetswipeCustomScanOverlayViewControllerDelegate> delegate;

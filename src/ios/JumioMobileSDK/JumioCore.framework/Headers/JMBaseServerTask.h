...
extern NSString *const kConfigurationKeyContentEncodingKey;
extern NSString *const kConfigurationKeyAcceptEncodingKey;
extern NSString *const kConfigurationKeyContentEncodingValue;
extern NSString *const kConfigurationKeyAcceptEncodingValue;
...
extern NSString *const kConfigurationKeyBoundary;


@interface JMBaseServerTaskResult : NSObject
